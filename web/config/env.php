...
if (PATH_SEPARATOR === ':' || PATH_SEPARATOR === ';') {
    @ini_set('include_path', dirname(dirname(dirname(__FILE__))) . DIRECTORY_SEPARATOR . 'ZendFramework-1.11.3' . DIRECTORY_SEPARATOR . 'library'
            . PATH_SEPARATOR . dirname(dirname(dirname(__FILE__))) . DIRECTORY_SEPARATOR . 'ZeedFramework' . DIRECTORY_SEPARATOR . 'library');
}
