...
//        showPageSizes: true,
        ...
        remote: {
            url: '/page/platform/getPlatform', //请求地址
            params: {}, //自定义请求参数
            success: function (result, pageIndex) {
                ...
                $.each(result.list, function (index, content) {
                    ...
                    var href_str = '/page/platform/detail?id='+content.news_id;
                    html += '<li>'+
                                '<span class="mtbd1" onclick="location.href=\''+href_str+'\'">'+content.news_title+'</span>'+
                                '<span class="mtbd2">'+content.ctime+'</span>'+
                            '</li>';
                });
