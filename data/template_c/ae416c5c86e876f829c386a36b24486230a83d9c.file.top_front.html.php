<?php /* Smarty version Smarty-3.1-DEV, created on 2016-10-13 18:56:18
         compiled from "/usr/local/httpd/htdocs/php/view/index/template/inc/top_front.html" */ ?>
<?php /*%%SmartyHeaderCode:37970764357f89c6976b542-10304665%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'ae416c5c86e876f829c386a36b24486230a83d9c' => 
    array (
      0 => '/usr/local/httpd/htdocs/php/view/index/template/inc/top_front.html',
      1 => 1476356176,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '37970764357f89c6976b542-10304665',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1-DEV',
  'unifunc' => 'content_57f89c6978c645_31949502',
  'variables' => 
  array (
    '_STATIC_CDN' => 0,
    'loggedInUser' => 0,
...
<?php if ($_valid && !is_callable('content_57f89c6978c645_31949502')) {function content_57f89c6978c645_31949502($_smarty_tpl) {?><!-- 头部结构开始-->
    ...
    <div class="nav_top w1200">
        ...
        <ul class="nav_top_left fl">
            <li id="sj" style="position:relative;">
                ...
                <img id="sjshow" width="145" height="145" style="z-index: 99;position: absolute;top:30px;left:0;display: none;" src="/static/ywf/img/icon/app.jpg">
            </li>
...
/ywf/img/icon/help.png) left center no-repeat;">
                <a href="javascript:;" onclick="location.href = '/page/help/index'">帮助中心</a>
...
<?php $_tmp1=ob_get_clean();?><?php if ($_tmp1){?>
        <div class="nav_top_bg buy_nav"> 
            <div class="nav_top_right buy_nav_top_right fr">
                ...
                <?php ob_start();?><?php echo $_smarty_tpl->tpl_vars['loggedInUser']->value['is_validate']==1;?>
<?php $_tmp2=ob_get_clean();?><?php if ($_tmp2){?>
                <a class="ren" href="/cas/user/index">认证
                    <span></span>
                </a>
                <?php }else{ ?>
